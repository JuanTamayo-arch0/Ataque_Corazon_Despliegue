# -*- coding: utf-8 -*-
"""Despliegue_ataque_corazon_personalizado.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/12pC8_wgP_3FxHA4Akz-yNZN_FvM9HS_T

# Despliegue - Predicción de Ataque de Corazón (stroke)
### Versión con interfaz personalizada (imagen, tarjetas de color, gauge de probabilidad y recomendaciones)

- Cargamos el modelo (Knn) entrenado en `4_Validacion_Cruzada_Class`
- Capturamos los datos por interfaz (o los cargamos desde archivo)
- Preparamos los datos: dummies (2 categorías y multicategoría) + normalización de variables numéricas
- Aplicamos el modelo, mostramos la predicción, la probabilidad y recomendaciones personalizadas
"""
...
print(Y_pred_decodificada, prob_riesgo)
